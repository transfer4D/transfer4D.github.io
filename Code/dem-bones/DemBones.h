	...
	*/
	...
	void computeWeights() {
		...
		for (_iterWeights=0; _iterWeights<nWeightsIters; _iterWeights++) {
			...
			// std::cout << "reg scale:" << reg_scale << std::endl;
...
// private:
	...
	*/
	void split(int maxB, int threshold) {
		...
		std::cout << "Calculating Err:" << nB << std::endl; 
		...
		std::cout << "Finding Seed:" << nB << std::endl; 
	...
	*/
	void compute_ws() {
		// std::cout << "Goint to Solve WS" << std::endl;
