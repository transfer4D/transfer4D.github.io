...
import torch
import lepard.cpp_wrappers.cpp_subsampling.grid_subsampling as cpp_subsampling
import lepard.cpp_wrappers.cpp_neighbors.radius_neighbors as cpp_neighbors
from lepard.datasets._3dmatch import _3DMatch
from lepard.datasets._4dmatch import _4DMatch
from lepard.datasets.utils import blend_scene_flow, multual_nn_correspondence
...
def collate_fn_4dmatch_inference(list_data, config, neighborhood_limits ):
    batched_points_list = []
    batched_features_list = []
    batched_lengths_list = []
    ...
    for ind, ( src_pcd, tgt_pcd, src_feats, tgt_feats) in enumerate(list_data):
